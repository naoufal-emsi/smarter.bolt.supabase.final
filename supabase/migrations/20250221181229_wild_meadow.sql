/*
  ...
  1. Changes
    ...
    - Remove username column and constraints
    - Add email column with proper constraints
    - Create new trigger function for user creation
*/
...
-- Remove username column and its constraints
...
-- Create new trigger function for handling user creation
